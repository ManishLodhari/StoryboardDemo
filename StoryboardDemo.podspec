...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of StoryboardDemo.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/manish.lodhari@pixometryinfosoft.com/StoryboardDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'manish.lodhari@pixometryinfosoft.com' => 'manish.lodhari@pixometryinfosoft.com' }
  s.source           = { :git => 'https://github.com/manish.lodhari@pixometryinfosoft.com/StoryboardDemo.git', :tag => s.version.to_s }
